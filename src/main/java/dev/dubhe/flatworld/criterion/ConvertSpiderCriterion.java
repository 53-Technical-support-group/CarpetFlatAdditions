...
public class ConvertSpiderCriterion extends AbstractCriterion<ConvertSpiderCriterion.Conditions> {
  static final Identifier ID = new Identifier("flatworld", "convert_spider");
  ...
  public static class Conditions extends AbstractCriterionConditions {
    ...
    public Conditions(EntityPredicate.Extended player, EntityPredicate.Extended spider, EntityPredicate.Extended caveSpider) {
      super(ID, player);
      this.spider = spider;
