...
public class FlatWorldSettings {
  public static final String SKYBLOCK = "flatworld";
  public static final String GENERATION = "generation";
  /* Generation -- Only obeyed with FlatWorld world generation */
  @Rule(
  ...
  /* Wandering Trader */
  @Rule(
    desc = "Add trades to the wandering trader for FlatWorld",
    category = {SKYBLOCK, FEATURE})
  public static boolean wanderingTraderFlatWorldTrades = false;
