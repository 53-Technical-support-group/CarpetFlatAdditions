            ...
            instance
              .group(
                RegistryOps.createRegistryCodec(
                  ...
                  .forGetter(flatworldChunkGenerator -> flatworldChunkGenerator.noiseRegistry),
                BiomeSource.CODEC
                  .fieldOf("biome_source")
                  .forGetter(FlatWorldChunkGenerator::getBiomeSource),
                Codec.LONG
                  .fieldOf("seed")
                  .stable()
                  .forGetter(FlatWorldChunkGenerator::getSeed),
