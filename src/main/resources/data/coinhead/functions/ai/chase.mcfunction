execute at @s run tp @s ~ ~ ~ facing entity @p[distance=..64]
...
execute at @s store result score #temp0 Speed1 run data get entity @p[distance=..64] Pos[0] 100
...
execute at @s store result score #temp0 Speed1 run data get entity @p[distance=..64] Pos[2] 100
